...
from optimizers.tokenizer_optimizers.LetterOptimizer import RQVAETokenizerOptimizer
from trainers.tokenizer_trainers.LetterTrainer import Trainer
...
class RQVAETrainingPipeline:
    ...
    def _initialize_components(self):
        ...
        self.tokenizer = LetterTokenizer(self.config)
