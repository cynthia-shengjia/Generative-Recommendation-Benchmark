...
from genrec.quantization.optimizers.letter_optimizer import LETTERRQVAETokenizerOptimizer
from genrec.quantization.trainers.letter_trainer import LETTERRQVAETrainer
...
class LETTERRQVAETrainingPipeline:
    """
