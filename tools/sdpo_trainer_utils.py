...
from trainers.offline_rl_trainers.SDPOCacheTrainer import SDPOTrainer
from genrec.datasets.sdpo_data_collator import S_DPOSeqRecDataCollator
...
# 使用示例
def setup_training(model, tokenizer, train_dataset, valid_dataset, model_config, output_dirs, logger, per_device_train_batch_size,per_device_eval_batch_size,eval_data_collator=None):
    ...
    # 创建 S-DPO DataCollator
    sdpo_data_collator = S_DPOSeqRecDataCollator(
    ...
    trainer = create_trainer(
        ...
        data_collator=sdpo_data_collator,
        callbacks=callbacks,
        ref_model=ref_model,
